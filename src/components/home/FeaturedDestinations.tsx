              ...
              <div className="p-4">
                ...
                <div className="flex gap-2">
                  ...
                  {dest.tourCount && dest.tourCount > 0 ? (
                    ...
                    <span className="flex-1 text-center py-2 bg-gray-100 dark:bg-gray-800 text-gray-400 dark:text-gray-500 rounded-xl text-sm font-medium cursor-not-allowed select-none">
                      No tours yet
                    </span>
                  )}
                </div>
